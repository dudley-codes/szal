...
Commands:
  ...
  memory recall               Show bounded current structured memory
...
Memory:
  ...
  szal memory recall [--project <directory>] [--query <text>] [--limit <count>] [--json]
...
Options:
  ...
  --json                       Emit JSON for config, doctor, and memory commands`);
  return 0;
};
